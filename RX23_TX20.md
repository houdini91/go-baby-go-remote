...
* **Remote pairing mode**
  When entering pairing mode, the remote transmits on a slightly different channel (\~2.439 GHz) at a noticeably slower burst rate.
...
* **Car response** (confirmed via HackRF)
  The car appears to respond on \~2.403 GHz using a similar burst format:
